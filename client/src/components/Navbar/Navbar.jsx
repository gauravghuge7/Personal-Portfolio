...
function Navbar() {
    ...
    return (
        <main>
            <nav className={`fixed top-0 w-full ${darkMode ? 'bg-gray-900' : 'bg-white'} ${darkMode ? 'text-white' : 'text-gray-900'} shadow-lg z-50 px-2 sm:px-4 py-2 sm:py-3 flex flex-wrap justify-between items-center gap-2`}>
                ...
                <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
                    ...
                    <ul className="hidden lg:flex items-center gap-4 xl:gap-6 text-sm">
                        {["Experience", "Education", "Projects", "Gallery", "Contact", "Information"].map((item) => (
                            <li key={item}>
                                <Link 
                                    to={`/${item}`} 
